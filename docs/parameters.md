# singleron-RD/sccite pipeline parameters
...
| Parameter | Description | Type | Default | Required | Hidden |
|-----------|-----------|-----------|-----------|-----------|-----------|
| `r2_pattern` | String used to locate the tag barcode in R2 reads. L:linker C:tag barcode. The number after L or C indicates the length. | `string` | L21C15 | True |  |
| `tag_barcode_fasta` | Path to tag_barcode fasta file. | `string` |  | True |  |
...
| Parameter | Description | Type | Default | Required | Hidden |
|-----------|-----------|-----------|-----------|-----------|-----------|
| `protocol` | Predefined pattern and whitelist. Can auto detect GEXSCOPE protocols. | `string` | auto | True |  |
